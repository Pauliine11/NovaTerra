...
function card(objet){
    ...
    strongPrice.textContent = parseFloat(objet.prix).toFixed(2) + " Crédits interstellaires";
...
function afficherPanier(){
    ...
    if(cart.length === 0){
        titleCart.textContent = "Panier vide";
        ...
        console.log(total);
        footerCart.textContent = total + " Crédits interstellaires";
    }
